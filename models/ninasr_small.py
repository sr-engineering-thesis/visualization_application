...
class NinaSR_small(nn.Module):
    def __init__(
        ...
        super(NinaSR_small, self).__init__()
        self.scale = scale
        n_colors = 3
        self.head = NinaSR_small.make_head(n_colors, n_feats)
        self.body = NinaSR_small.make_body(n_resblocks, n_feats, expansion)
        self.tail = NinaSR_small.make_tail(n_colors, n_feats, scale)
